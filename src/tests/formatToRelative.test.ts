...
describe("formatRelativeTime", () => {
  ...
  it("positive tests", () => {
    ...
    expect(formatRelativeTime("2023-03-16T18:24:20.427Z", "en-GB")).toBe(
      "3 weeks ago"
    );
    expect(formatRelativeTime("2023-02-03T16:24:20.427Z", "es-ES")).toBe(
      "hace 2 meses"
    );
    ...
    expect(formatRelativeTime("2005-04-04T16:24:20.427Z", "en")).toBe(
      "20 years ago"
    );
    expect(formatRelativeTime("1905-01-31T22:32:20.427Z", "qweqwe12312")).toBe(
      "129 years ago"
    );
    expect(formatRelativeTime("2023-06-03T16:24:20.427Z", "111")).toBe(
      "in 2 months"
    );
    expect(formatRelativeTime("2026-06-03T20:15:20.427Z", "qweqwe12312")).toBe(
      "in 3 years"
    );
  });
  it("error tests", () => {
